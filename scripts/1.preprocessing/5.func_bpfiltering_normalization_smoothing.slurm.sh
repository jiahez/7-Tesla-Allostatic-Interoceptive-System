...
rm $STUDY_DIR/derivatives/$subj/rest/001/f_st_mc_regout_hp.nii.gz

## NORMALIZATION DONE USING SOURCED SCRIPT: normalization.sh 
source $STUDY_DIR/scripts/1.preprocessing/functions/normalization.sh
...
rm $STUDY_DIR/derivatives/$subj/rest/001/f_st_mc_regout_bp_m_2MNI_Tmean.nii.gz
...
rm $STUDY_DIR/derivatives/$subj/rest/001/f_st_mc_regout_bp_m_2MNI_LIA.nii.gz
